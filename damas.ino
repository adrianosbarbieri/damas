...
int matrix_old[8][8] = {{E, A, E, A, E, A, E, A}, {A, E, A, E, A, E, A, E}, {E, A, E, A, E, A, E, A},
                        {E, E, E, E, E, E, E, E}, {E, E, E, E, E, E, E, E}, {B, E, B, E, B, E, B, E},
                        {E, B, E, B, E, B, E, B}, {B, E, B, E, B, E, B, E}};
...
const int led_matrix[8][8] = {{-1, 2, -1, 4, -1, 6, -1, 8},     {19, -1, 17, -1, 15, -1, 13, -1},
                              {-1, 23, -1, 25, -1, 27, -1, 29}, {39, -1, 37, -1, 35, -1, 33, -1},
                              {-1, 43, -1, 45, -1, 47, -1, 49}, {59, -1, 57, -1, 55, -1, 53, -1},
                              {-1, 63, -1, 65, -1, 67, -1, 69}, {79, -1, 77, -1, 75, -1, 73, -1}};
        ...
        for(int j = 0; j < 8; j++)
        {
            if(led_matrix[i][j] > 0)
            {
                ...
                case BT:
                    ...
                    break;
                case AK:
                    pixels.setPixelColor(led_matrix[i][j], pixels.Color(0, 0, 200));
                    break;
                case BK:
                    pixels.setPixelColor(led_matrix[i][j], pixels.Color(200, 0, 0));
                    break;
                case AKT:
                    pixels.setPixelColor(led_matrix[i][j], pixels.Color(0, 200, 200));
                    break;
                case BKT:
                    pixels.setPixelColor(led_matrix[i][j], pixels.Color(200, 200, 0));
                    break;
                case E:
...
void threat_square(int x, int y)
{
    ...
    else if(matrix[x][y] == BK && curr_turn == false)
    {
        for(int i = 0; i < 8; i++)
        {
            if(x + 2 + i < 8 && y + 2 + i < 8)
